...
class GQA(nn.Module):
    ...
    def forward(self, x):
        ...
        values = values.transpose(0,3,4,1,2) # batch_size x 8 x 1 x seq_len x 64
        ...
        #concatenate heads
        context_vector = context_vector.view(batch_size, seq_len, hidden_dim) # batch_size x seq_len x 1024
