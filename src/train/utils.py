...
def pretokenize(txt_file: List[str], token_path: str = "data/tokens") -> None:
    """
...
def plot_losses(epochs_seen, loss: list[float], save_path: str) -> None:
